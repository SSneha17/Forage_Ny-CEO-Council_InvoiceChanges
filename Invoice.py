...
class Invoice:
    ...
    ''' Functionality to add, view and edit comments '''
...
if __name__ == '__main__':
    ...
    invoice.view_comments()
    invoice.add_comment("Initial Test Invoice Comment.")
    invoice.add_comment("Finalized and approved Invoice.")
